        ...
        app.ports.event2js.subscribe(function(cmd) {
            ...
            switch (cmd[0]) {
              ...
              case "init": {
                  ...
                  dbInit();
                  dbLoad("code", cmd[1], app.ports.event2elm.send);
                  dbLoad("quiz", cmd[1], app.ports.event2elm.send);
                  dbLoad("survey", cmd[1], app.ports.event2elm.send);
                  break;
              }
              case "settings": {
