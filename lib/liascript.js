...
function lia_exec(app, delay, code) {
    try {
...
class LiaScript {
    constructor(elem, script, url="", slide=0) {
        ...
        this.initPreferences(this.app);
    }

    initPreferences(app) {
        app.ports.initialize.subscribe(function(cmd) {
            document.title = cmd[0];
            uidDB = cmd[1];
            dbInit();
              ...
              case "code" : {
                  cmd[2].forEach(function(e) {
                      switch(e[0]) {
                          ...
                          case "stdin": {
                              console.log("stdin", cmd[1], e[1], e[2]);
                              break;
                          }
                          default: {
                              console.log(e[0], cmd[1], e);
                          }
                      }});
