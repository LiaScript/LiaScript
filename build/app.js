...
var _user$project$Lia_Model$Model = F5(
	function (a, b, c, d, e) {
		return {script: a, error: b, lia: c, slide: d, mode: e};
	});
...
var _user$project$Lia_Parser$program = function () {
...
var _user$project$Lia_Parser$run = function (script) {
	var _p19 = A2(_elm_community$parser_combinators$Combine$parse, _user$project$Lia_Parser$program, script);
	if (_p19.ctor === 'Ok') {
...
var _user$project$Lia_Utils$mathjax = function (s) {
	var $void = _user$project$Native_Utils.mathjax(
		{ctor: '_Tuple0'});
	return {ctor: '_Tuple0'};
};
...
var _user$project$Lia_View$view_block = function (block) {
	var _p5 = block;
	switch (_p5.ctor) {
		case 'Paragraph':
			return A2(
				...
				{ctor: '[]'},
				A2(_elm_lang$core$List$map, _user$project$Lia_View$view_inline, _p5._0));
		case 'HorizontalLine':
			return A2(
		...
		case 'Table':
			return A3(
				...
				_p5._0,
				_elm_lang$core$Array$fromList(_p5._1),
				_p5._2);
		case 'Quote':
			return A2(
			...
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: A2(_user$project$Lia_Utils$highlight, _p5._0, _p5._1),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				});
...
var _user$project$Lia_View$view_body = function (body) {
	return A2(_elm_lang$core$List$map, _user$project$Lia_View$view_block, body);
};
...
var _user$project$Lia_View$view_slide = function (slide) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: _user$project$Lia_View$view_body(slide.body)
		});
};
var _user$project$Lia_View$view_slides = F2(
	function (slides, active) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					A2(
						...
						A2(
										...
										_0: A2(
											_elm_lang$html$Html$a,
											{
												...
												_0: _elm_lang$html$Html_Events$onClick(
													_user$project$Lia_Type$Load(_p8._0)),
												_1: {
													ctor: '::',
														...
														_0: _elm_lang$html$Html_Attributes$style(
															{
																...
																_0: {
																	...
																	_1: A2(
																		_elm_lang$core$Basics_ops['++'],
																		_elm_lang$core$Basics$toString((_p8._1._1 - 1) * 20),
																		'px')
																},
																_1: {ctor: '[]'}
															}),
							...
							_user$project$Lia_Helper$get_headers(slides)),
						{
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$button,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$Lia_Type$Load(active - 1)),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$style(
											{
				...
				_1: {
					...
					_0: A2(
						...
						},
						{
							ctor: '::',
							_0: function () {
								var _p10 = A2(_user$project$Lia_Helper$get_slide, active, slides);
								if (_p10.ctor === 'Just') {
									return A2(_elm_lang$html$Html_Lazy$lazy, _user$project$Lia_View$view_slide, _p10._0);
								} else {
...
var _user$project$Lia_View$view_plain = function (slides) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		A2(_elm_lang$core$List$map, _user$project$Lia_View$view_slide, slides));
};
var _user$project$Lia_View$view = F3(
	function (mode, slides, num) {
		var x = _user$project$Lia_Utils$mathjax(
			{ctor: '_Tuple0'});
		var html = function () {
			var _p11 = mode;
			if (_p11.ctor === 'Slides') {
				return A2(_user$project$Lia_View$view_slides, slides, num);
			} else {
				return _user$project$Lia_View$view_plain(slides);
			}
		}();
		return html;
	});
...
var _user$project$Lia$view = function (model) {
	return A3(_user$project$Lia_View$view, model.mode, model.lia, model.slide);
};
