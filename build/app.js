...
var _user$project$Lia_Parser$single_choice = function () {
...
var _user$project$Lia_Parser$multiple_choice = A2(
	_elm_community$parser_combinators$Combine_ops['<$>'],
...
var _user$project$Lia_Parser$quiz = function () {
	...
	return A2(
		...
		A2(
			...
			A2(_elm_community$parser_combinators$Combine_ops['<|>'], _user$project$Lia_Parser$single_choice, _user$project$Lia_Parser$multiple_choice)),
		counter);
}();
				...
				if (_p0._0._1.ctor === 'Single') {
					if ((_p0._0._0.ctor === 'Just') && (_p0._0._0._0 === true)) {
						...
						return A3(
							...
							quiz_id,
							{
								...
								_1: A2(_user$project$Lia_Type$Single, _p2, _p1)
							},
							matrix);
					}
				} else {
					if ((_p0._0._0.ctor === 'Just') && (_p0._0._0._0 === true)) {
						...
						var f = F2(
							function (_p3, r) {
								var _p4 = _p3;
								return r && _elm_lang$core$Native_Utils.eq(_p4._0, _p4._1);
							});
						return A3(
							_elm_lang$core$Array$set,
							quiz_id,
							{
								ctor: '_Tuple2',
								_0: _elm_lang$core$Maybe$Just(
									A3(_elm_lang$core$Array$foldr, f, true, _p5)),
								_1: _user$project$Lia_Type$Multi(_p5)
							},
							matrix);
					}
				}
...
var _user$project$Lia_Update$flip_checkbox = F3(
	function (quiz_id, question_id, matrix) {
		var _p6 = A2(_elm_lang$core$Array$get, quiz_id, matrix);
		_v2_0:
		do {
			if ((_p6.ctor === 'Just') && (_p6._0.ctor === '_Tuple2')) {
				if (_p6._0._1.ctor === 'Single') {
					if ((_p6._0._0.ctor === 'Just') && (_p6._0._0._0 === true)) {
						break _v2_0;
					} else {
						return A3(
							_elm_lang$core$Array$set,
							quiz_id,
							{
								ctor: '_Tuple2',
								_0: _p6._0._0,
								_1: A2(_user$project$Lia_Type$Single, question_id, _p6._0._1._1)
							},
							matrix);
					}
				} else {
...
var _user$project$Lia_Update$update = F2(
	function (msg, model) {
		...
		while (true) {
			...
			switch (_p11.ctor) {
				case 'Load':
					var _v6 = _user$project$Lia_Type$Speak('Starting to load next slide'),
