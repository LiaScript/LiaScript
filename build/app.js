...
var _doodledood$elm_split_pane$Bound$boundTo = function (_p0) {
	var _p1 = _p0;
	return function (_p2) {
		return A2(
			_elm_lang$core$Basics$min,
			_p1._1,
			A2(_elm_lang$core$Basics$max, _p1._0, _p2));
	};
};
var _doodledood$elm_split_pane$Bound$createBound = F2(
	function (a, b) {
		return {
			ctor: '_Tuple2',
...
var _doodledood$elm_split_pane$Bound$putBound = F2(
	function (_p3, bound) {
		var _p4 = _p3;
		return {ctor: '_Tuple2', _0: _p4._0, _1: bound};
	});
var _doodledood$elm_split_pane$Bound$putValue = F2(
	function (_p5, value) {
		var _p6 = _p5;
		var _p7 = _p6._1;
		return {
			ctor: '_Tuple2',
			_0: A2(_doodledood$elm_split_pane$Bound$boundTo, _p7, value),
			_1: _p7
		};
	});
var _doodledood$elm_split_pane$Bound$createBounded = F2(
	function (value, bound) {
		return A2(
			_doodledood$elm_split_pane$Bound$putValue,
			{ctor: '_Tuple2', _0: value, _1: bound},
			value);
	});
...
var _doodledood$elm_split_pane$Styles$baseDefaultSplitterStyles = {
	ctor: '::',
	...
	_1: {
		...
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'boxSizing', _1: 'border-box'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'opacity', _1: '.2'},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'zIndex', _1: '1'},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'webkitUserSelect', _1: 'none'},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'mozUserSelect', _1: 'none'},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'userSelect', _1: 'none'},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'backgroundClip', _1: 'padding-box'},
									_1: {ctor: '[]'}
								}
							}
						}
...
var _doodledood$elm_split_pane$Styles$defaultHorizontalSplitterStyle = function (isDraggable) {
	return _elm_lang$html$Html_Attributes$style(
		A2(
			_elm_lang$core$Basics_ops['++'],
			_doodledood$elm_split_pane$Styles$baseDefaultSplitterStyles,
			A2(
				_elm_lang$core$Basics_ops['++'],
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'width', _1: '11px'},
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'borderLeft', _1: '5px solid rgba(255, 255, 255, 0)'},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'borderRight', _1: '5px solid rgba(255, 255, 255, 0)'},
									_1: {ctor: '[]'}
								}
							}
						}
				...
				isDraggable ? {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'cursor', _1: 'col-resize'},
					_1: {ctor: '[]'}
				} : {ctor: '[]'})));
};
var _doodledood$elm_split_pane$Styles$defaultVerticalSplitterStyle = function (isDraggable) {
	return _elm_lang$html$Html_Attributes$style(
		A2(
			_elm_lang$core$Basics_ops['++'],
			_doodledood$elm_split_pane$Styles$baseDefaultSplitterStyles,
			A2(
				...
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'height', _1: '11px'},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'width', _1: '100%'},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'margin', _1: '-5px 0'},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'borderTop', _1: '5px solid rgba(255, 255, 255, 0)'},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'borderBottom', _1: '5px solid rgba(255, 255, 255, 0)'},
									_1: {ctor: '[]'}
								}
							}
						}
				...
				isDraggable ? {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'cursor', _1: 'row-resize'},
					_1: {ctor: '[]'}
				} : {ctor: '[]'})));
};
var _doodledood$elm_split_pane$Styles$childViewStyle = function (fraction) {
	return _elm_lang$html$Html_Attributes$style(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'flex',
				_1: _elm_lang$core$Basics$toString(fraction)
			},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'width', _1: '100%'},
...
var _doodledood$elm_split_pane$Styles$paneContainerStyle = function (isHorizontal) {
	return _elm_lang$html$Html_Attributes$style(
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'overflow', _1: 'hidden'},
...
var _doodledood$elm_split_pane$SplitPane$createDefaultSplitterDetails = F2(
	function (orientation, draggable) {
		var _p0 = orientation;
		if (_p0.ctor === 'Horizontal') {
			return {
				attributes: {
					ctor: '::',
					_0: _doodledood$elm_split_pane$Styles$defaultHorizontalSplitterStyle(draggable),
					_1: {ctor: '[]'}
				},
				children: {ctor: '[]'}
			};
			...
			return {
				attributes: {
					ctor: '::',
					_0: _doodledood$elm_split_pane$Styles$defaultVerticalSplitterStyle(draggable),
					_1: {ctor: '[]'}
				},
				children: {ctor: '[]'}
			};
...
var _doodledood$elm_split_pane$SplitPane$domInfoToPosition = function (_p1) {
	var _p2 = _p1;
	var _p3 = {ctor: '_Tuple4', _0: _p2.x, _1: _p2.y, _2: _p2.touchX, _3: _p2.touchY};
	_v2_2:
	do {
		if (_p3.ctor === '_Tuple4') {
			if ((_p3._2.ctor === 'Just') && (_p3._3.ctor === 'Just')) {
				return {x: _p3._2._0, y: _p3._3._0};
			} else {
				if ((_p3._0.ctor === 'Just') && (_p3._1.ctor === 'Just')) {
					return {x: _p3._0._0, y: _p3._1._0};
				} else {
					break _v2_2;
				}
			}
...
var _doodledood$elm_split_pane$SplitPane$setPercentage = F2(
	function (x, _p4) {
		var _p5 = _p4;
		return A2(
			_doodledood$elm_split_pane$Bound$createBounded,
			A2(_doodledood$elm_split_pane$Bound$putValue, _p5._0, x),
			_p5._1);
	});
var _doodledood$elm_split_pane$SplitPane$getPercentage = function (_p6) {
	return _elm_lang$core$Tuple$first(
		_elm_lang$core$Tuple$first(_p6));
};
var _doodledood$elm_split_pane$SplitPane$resize = F5(
	function (orientation, splitterPosition, newPosition, paneWidth, paneHeight) {
		var _p7 = orientation;
		if (_p7.ctor === 'Horizontal') {
			var prevPositionX = _elm_lang$core$Basics$round(
				_elm_lang$core$Basics$toFloat(paneWidth) * _doodledood$elm_split_pane$SplitPane$getPercentage(splitterPosition));
			var newSplitterValue = _doodledood$elm_split_pane$SplitPane$getPercentage(splitterPosition) + (_elm_lang$core$Basics$toFloat(newPosition.x - prevPositionX) / _elm_lang$core$Basics$toFloat(paneWidth));
			return A2(_doodledood$elm_split_pane$SplitPane$setPercentage, newSplitterValue, splitterPosition);
		} else {
			var prevPositionY = _elm_lang$core$Basics$round(
				_elm_lang$core$Basics$toFloat(paneHeight) * _doodledood$elm_split_pane$SplitPane$getPercentage(splitterPosition));
			var newSplitterValue = _doodledood$elm_split_pane$SplitPane$getPercentage(splitterPosition) + (_elm_lang$core$Basics$toFloat(newPosition.y - prevPositionY) / _elm_lang$core$Basics$toFloat(paneHeight));
			return A2(_doodledood$elm_split_pane$SplitPane$setPercentage, newSplitterValue, splitterPosition);
		}
	});
var _doodledood$elm_split_pane$SplitPane$percentage = function (x) {
	return A2(
		_doodledood$elm_split_pane$Bound$createBounded,
		x,
		A2(_doodledood$elm_split_pane$Bound$createBound, 0.0, 1.0));
};
var _doodledood$elm_split_pane$SplitPane$PaneDOMInfo = F2(
	function (a, b) {
		return {paneWidth: a, paneHeight: b};
	});
var _doodledood$elm_split_pane$SplitPane$Position = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _doodledood$elm_split_pane$SplitPane$HtmlDetails = F2(
	function (a, b) {
		return {attributes: a, children: b};
	});
var _doodledood$elm_split_pane$SplitPane$DOMInfo = F6(
	function (a, b, c, d, e, f) {
		return {x: a, y: b, touchX: c, touchY: d, parentWidth: e, parentHeight: f};
	});
var _doodledood$elm_split_pane$SplitPane$domInfo = A7(
	_elm_lang$core$Json_Decode$map6,
	_doodledood$elm_split_pane$SplitPane$DOMInfo,
	_elm_lang$core$Json_Decode$maybe(
	...
	A2(
		...
		_elm_lang$core$Json_Decode$int));
var _doodledood$elm_split_pane$SplitPane$Vertical = {ctor: 'Vertical'};
var _doodledood$elm_split_pane$SplitPane$Horizontal = {ctor: 'Horizontal'};
var _doodledood$elm_split_pane$SplitPane$NotDraggable = {ctor: 'NotDraggable'};
var _doodledood$elm_split_pane$SplitPane$Draggable = function (a) {
	return {ctor: 'Draggable', _0: a};
};
var _doodledood$elm_split_pane$SplitPane$State = function (a) {
	return {ctor: 'State', _0: a};
};
var _doodledood$elm_split_pane$SplitPane$draggable = F2(
	function (isDraggable, _p8) {
		var _p9 = _p8;
		return _doodledood$elm_split_pane$SplitPane$State(
			_elm_lang$core$Native_Utils.update(
				_p9._0,
				{
					dragState: isDraggable ? _doodledood$elm_split_pane$SplitPane$Draggable(_elm_lang$core$Maybe$Nothing) : _doodledood$elm_split_pane$SplitPane$NotDraggable
				}));
	});
var _doodledood$elm_split_pane$SplitPane$orientation = F2(
	function (o, _p10) {
		var _p11 = _p10;
		return _doodledood$elm_split_pane$SplitPane$State(
			_elm_lang$core$Native_Utils.update(
...
var _doodledood$elm_split_pane$SplitPane$withSplitterAt = F2(
	function (newPosition, _p12) {
		var _p13 = _p12;
		var _p14 = _p13._0;
		return _doodledood$elm_split_pane$SplitPane$State(
			_elm_lang$core$Native_Utils.update(
				_p14,
				{
					splitterPosition: A2(_doodledood$elm_split_pane$Bound$putValue, _p14.splitterPosition, newPosition)
				}));
	});
var _doodledood$elm_split_pane$SplitPane$withResizeLimits = F2(
	function (newResizeLimit, _p15) {
		var _p16 = _p15;
		var _p17 = _p16._0;
		return _doodledood$elm_split_pane$SplitPane$State(
			_elm_lang$core$Native_Utils.update(
				_p17,
				{
					splitterPosition: A2(_doodledood$elm_split_pane$Bound$putBound, _p17.splitterPosition, newResizeLimit)
				}));
	});
var _doodledood$elm_split_pane$SplitPane$init = function (orientation) {
	return _doodledood$elm_split_pane$SplitPane$State(
		{
			orientation: orientation,
			splitterPosition: {
				ctor: '_Tuple2',
				_0: _doodledood$elm_split_pane$SplitPane$percentage(0.5),
				_1: A2(
					_doodledood$elm_split_pane$Bound$createBound,
					_doodledood$elm_split_pane$SplitPane$percentage(0.0),
					_doodledood$elm_split_pane$SplitPane$percentage(1.0))
			},
			dragState: _doodledood$elm_split_pane$SplitPane$Draggable(_elm_lang$core$Maybe$Nothing)
		});
};
var _doodledood$elm_split_pane$SplitPane$customUpdate = F3(
	function (_p19, msg, _p18) {
		var _p20 = _p19;
		var _p25 = _p20._0;
		var _p21 = _p18;
		var _p24 = _p21._0;
		var _p22 = {ctor: '_Tuple2', _0: _p24.dragState, _1: msg};
		_v11_3:
		do {
			if ((_p22.ctor === '_Tuple2') && (_p22._0.ctor === 'Draggable')) {
				if (_p22._0._0.ctor === 'Nothing') {
					if (_p22._1.ctor === 'SplitterClick') {
						var _p23 = _p22._1._0;
						return {
							ctor: '_Tuple2',
							_0: _doodledood$elm_split_pane$SplitPane$State(
								_elm_lang$core$Native_Utils.update(
									_p24,
									{
										dragState: _doodledood$elm_split_pane$SplitPane$Draggable(
											_elm_lang$core$Maybe$Just(
												{paneWidth: _p23.parentWidth, paneHeight: _p23.parentHeight}))
									})),
							_1: _p25.onResizeStarted
						};
					} else {
						break _v11_3;
					}
					...
					switch (_p22._1.ctor) {
						case 'SplitterLeftAlone':
							return {
								...
								_1: _p25.onResizeEnded
							};
						case 'SplitterMove':
							var newSplitterPosition = A5(_doodledood$elm_split_pane$SplitPane$resize, _p24.orientation, _p24.splitterPosition, _p22._1._0, _p22._0._0._0.paneWidth, _p22._0._0._0.paneHeight);
							return {
								ctor: '_Tuple2',
								_0: _doodledood$elm_split_pane$SplitPane$State(
									_elm_lang$core$Native_Utils.update(
								...
								_1: _p25.onResize(
									_doodledood$elm_split_pane$SplitPane$getPercentage(newSplitterPosition))
							};
						default:
							break _v11_3;
					}
		...
		return {
			ctor: '_Tuple2',
			_0: _doodledood$elm_split_pane$SplitPane$State(_p24),
			_1: _elm_lang$core$Maybe$Nothing
		};
	});
var _doodledood$elm_split_pane$SplitPane$SplitterLeftAlone = function (a) {
	return {ctor: 'SplitterLeftAlone', _0: a};
};
var _doodledood$elm_split_pane$SplitPane$onTouchEnd = function (toMsg) {
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'touchend',
		...
		A2(
			...
			function (_p26) {
				return toMsg(
					_doodledood$elm_split_pane$SplitPane$SplitterLeftAlone(
						_doodledood$elm_split_pane$SplitPane$domInfoToPosition(_p26)));
			},
			_doodledood$elm_split_pane$SplitPane$domInfo));
};
var _doodledood$elm_split_pane$SplitPane$onTouchCancel = function (toMsg) {
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'touchcancel',
		{preventDefault: true, stopPropagation: true},
		A2(
			...
			function (_p27) {
				return toMsg(
					_doodledood$elm_split_pane$SplitPane$SplitterLeftAlone(
						_doodledood$elm_split_pane$SplitPane$domInfoToPosition(_p27)));
			},
			_doodledood$elm_split_pane$SplitPane$domInfo));
};
var _doodledood$elm_split_pane$SplitPane$SplitterMove = function (a) {
	return {ctor: 'SplitterMove', _0: a};
};
var _doodledood$elm_split_pane$SplitPane$onTouchMove = function (toMsg) {
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'touchmove',
		{preventDefault: true, stopPropagation: true},
		A2(
			...
			function (_p28) {
				return toMsg(
					_doodledood$elm_split_pane$SplitPane$SplitterMove(
						_doodledood$elm_split_pane$SplitPane$domInfoToPosition(_p28)));
			},
			_doodledood$elm_split_pane$SplitPane$domInfo));
};
var _doodledood$elm_split_pane$SplitPane$subscriptions = function (_p29) {
	var _p30 = _p29;
	var _p31 = _p30._0.dragState;
	if ((_p31.ctor === 'Draggable') && (_p31._0.ctor === 'Just')) {
		return _elm_lang$core$Platform_Sub$batch(
			{
				ctor: '::',
				_0: _elm_lang$mouse$Mouse$moves(_doodledood$elm_split_pane$SplitPane$SplitterMove),
				_1: {
					ctor: '::',
					_0: _elm_lang$mouse$Mouse$ups(_doodledood$elm_split_pane$SplitPane$SplitterLeftAlone),
					_1: {ctor: '[]'}
				}
			});
	} else {
...
var _doodledood$elm_split_pane$SplitPane$SplitterClick = function (a) {
	return {ctor: 'SplitterClick', _0: a};
};
var _doodledood$elm_split_pane$SplitPane$onMouseDown = function (toMsg) {
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'mousedown',
		...
		A2(
			...
			function (_p32) {
				return toMsg(
					_doodledood$elm_split_pane$SplitPane$SplitterClick(_p32));
			},
			_doodledood$elm_split_pane$SplitPane$domInfo));
};
var _doodledood$elm_split_pane$SplitPane$onTouchStart = function (toMsg) {
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'touchstart',
		{preventDefault: true, stopPropagation: true},
		A2(
			...
			function (_p33) {
				return toMsg(
					_doodledood$elm_split_pane$SplitPane$SplitterClick(_p33));
			},
			_doodledood$elm_split_pane$SplitPane$domInfo));
};
var _doodledood$elm_split_pane$SplitPane$UpdateConfig = function (a) {
	return {ctor: 'UpdateConfig', _0: a};
};
var _doodledood$elm_split_pane$SplitPane$createUpdateConfig = function (config) {
	return _doodledood$elm_split_pane$SplitPane$UpdateConfig(config);
};
var _doodledood$elm_split_pane$SplitPane$update = F2(
	function (msg, model) {
		var _p34 = A3(
			_doodledood$elm_split_pane$SplitPane$customUpdate,
			_doodledood$elm_split_pane$SplitPane$createUpdateConfig(
				{
					onResize: function (_p35) {
						return _elm_lang$core$Maybe$Nothing;
					},
					onResizeStarted: _elm_lang$core$Maybe$Nothing,
					onResizeEnded: _elm_lang$core$Maybe$Nothing
				}),
			msg,
			model);
		var updatedModel = _p34._0;
		return updatedModel;
	});
var _doodledood$elm_split_pane$SplitPane$CustomSplitter = function (a) {
	return {ctor: 'CustomSplitter', _0: a};
};
var _doodledood$elm_split_pane$SplitPane$createCustomSplitter = F2(
	function (toMsg, details) {
		return _doodledood$elm_split_pane$SplitPane$CustomSplitter(
			A2(
				_elm_lang$html$Html$span,
				{
					ctor: '::',
					_0: _doodledood$elm_split_pane$SplitPane$onMouseDown(toMsg),
					_1: {
						ctor: '::',
						_0: _doodledood$elm_split_pane$SplitPane$onTouchStart(toMsg),
						_1: {
							ctor: '::',
							_0: _doodledood$elm_split_pane$SplitPane$onTouchEnd(toMsg),
							_1: {
								ctor: '::',
								_0: _doodledood$elm_split_pane$SplitPane$onTouchMove(toMsg),
								_1: {
									ctor: '::',
									_0: _doodledood$elm_split_pane$SplitPane$onTouchCancel(toMsg),
									_1: details.attributes
								}
							}
						}
					}
...
var _doodledood$elm_split_pane$SplitPane$getConcreteSplitter = F3(
	function (viewConfig, orientation, draggable) {
		var _p36 = viewConfig.splitter;
		if (_p36.ctor === 'Just') {
			return _p36._0._0;
		} else {
			var _p37 = A2(
				_doodledood$elm_split_pane$SplitPane$createCustomSplitter,
				viewConfig.toMsg,
				A2(_doodledood$elm_split_pane$SplitPane$createDefaultSplitterDetails, orientation, draggable));
			return _p37._0;
		}
	});
var _doodledood$elm_split_pane$SplitPane$view = F4(
	function (_p39, firstView, secondView, _p38) {
		var _p40 = _p39;
		var _p44 = _p40._0;
		var _p41 = _p38;
		var _p43 = _p41._0;
		var splitter = function () {
			var _p42 = _p43.dragState;
			if (_p42.ctor === 'Draggable') {
				return A3(_doodledood$elm_split_pane$SplitPane$getConcreteSplitter, _p44, _p43.orientation, true);
			} else {
				return A3(_doodledood$elm_split_pane$SplitPane$getConcreteSplitter, _p44, _p43.orientation, false);
			}
		}();
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('pane-container'),
				_1: {
					ctor: '::',
					_0: _doodledood$elm_split_pane$Styles$paneContainerStyle(
						_elm_lang$core$Native_Utils.eq(_p43.orientation, _doodledood$elm_split_pane$SplitPane$Horizontal)),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('pane-first-view'),
						_1: {
							ctor: '::',
							_0: _doodledood$elm_split_pane$Styles$childViewStyle(
								_doodledood$elm_split_pane$SplitPane$getPercentage(_p43.splitterPosition)),
							_1: {ctor: '[]'}
						}
					},
					{
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('pane-second-view'),
								_1: {
									ctor: '::',
									_0: _doodledood$elm_split_pane$Styles$childViewStyle(
										1 - _doodledood$elm_split_pane$SplitPane$getPercentage(_p43.splitterPosition)),
									_1: {ctor: '[]'}
								}
							},
							{
...
var _doodledood$elm_split_pane$SplitPane$ViewConfig = function (a) {
	return {ctor: 'ViewConfig', _0: a};
};
var _doodledood$elm_split_pane$SplitPane$createViewConfig = function (_p45) {
	var _p46 = _p45;
	return _doodledood$elm_split_pane$SplitPane$ViewConfig(
		{toMsg: _p46.toMsg, splitter: _p46.customSplitter});
};
...
var _user$project$Lia_Inline_Types$EInline = F3(
	function (a, b, c) {
		return {ctor: 'EInline', _0: a, _1: b, _2: c};
	});
...
var _user$project$Lia_Inline_Types$Partial = function (a) {
	return {ctor: 'Partial', _0: a};
};
var _user$project$Lia_Inline_Types$Full = function (a) {
	return {ctor: 'Full', _0: a};
};
var _user$project$Lia_Inline_Types$Mail = function (a) {
...
var _user$project$Lia_Chart_Types$Point = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _user$project$Lia_Chart_Types$Diagram = function (a) {
	return {ctor: 'Diagram', _0: a};
};
...
var _user$project$Lia_Types$Chart = function (a) {
	return {ctor: 'Chart', _0: a};
};
var _user$project$Lia_Types$SurveyBlock = function (a) {
	return {ctor: 'SurveyBlock', _0: a};
};
...
var _user$project$Lia_Types$EComment = F2(
	function (a, b) {
		return {ctor: 'EComment', _0: a, _1: b};
	});
var _user$project$Lia_Types$EBlock = F3(
	function (a, b, c) {
		return {ctor: 'EBlock', _0: a, _1: b, _2: c};
	});
...
var _user$project$Lia_Index_Model$parse_url = function (url) {
	var _p0 = url;
	switch (_p0.ctor) {
		case 'Full':
			return _p0._0;
		...
		switch (_p1.ctor) {
					...
					case 'Link':
						return A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								' ',
								_user$project$Lia_Index_Model$parse_url(_p2._1)));
					case 'Image':
						return A2(
							_elm_lang$core$Basics_ops['++'],
							_p2._0,
			...
			case 'EInline':
				return _elm_lang$core$String$concat(
					A2(_elm_lang$core$List$map, _user$project$Lia_Index_Model$parse_inline, _p1._2));
			default:
				return '';
		}
	}
...
var _user$project$Lia_Effect_Model$Model = F5(
	function (a, b, c, d, e) {
		return {visible: a, effects: b, status: c, comments: d, narator: e};
	});
var _user$project$Lia_Effect_Model$Error = function (a) {
	return {ctor: 'Error', _0: a};
};
var _user$project$Lia_Effect_Model$Silent = {ctor: 'Silent'};
var _user$project$Lia_Effect_Model$init = F2(
	function (narator, maybe) {
		var _p7 = maybe;
		if (_p7.ctor === 'Just') {
			var _p8 = _p7._0;
			return A5(
			...
			return A5(_user$project$Lia_Effect_Model$Model, 0, 0, _user$project$Lia_Effect_Model$Silent, _elm_lang$core$Array$empty, narator);
		}
	});
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {script: a, error: b, mode: c, slides: d, current_slide: e, show_contents: f, quiz_model: g, code_model: h, effect_model: i, index_model: j, survey_model: k, narator: l};
											};
										};
									};
								};
...
var _user$project$Lia_Chart_Parser$number = A2(
	_elm_community$parser_combinators$Combine_ops['<|>'],
	_elm_community$parser_combinators$Combine_Num$float,
	A2(
		_elm_community$parser_combinators$Combine_ops['<$>'],
		...
		A2(
			...
			A2(
				...
				'.',
				_elm_community$parser_combinators$Combine$string('.')))));
var _user$project$Lia_Chart_Parser$x_axis = function () {
	var segmentation = F3(
		function (elments, x0, x1) {
			return {
				ctor: '_Tuple2',
				_0: x0,
				_1: (x1 - x0) / _elm_lang$core$Basics$toFloat(
					_elm_lang$core$String$length(elments))
			};
		});
	return A2(
		_elm_community$parser_combinators$Combine_ops['<*>'],
		A2(
			...
			A2(
				...
				A2(
					...
					_elm_community$parser_combinators$Combine$regex('( )*\\n( )*'))),
			_user$project$Lia_Chart_Parser$number),
		A2(
			_elm_community$parser_combinators$Combine_ops['<*'],
			A2(
				_elm_community$parser_combinators$Combine_ops['*>'],
...
var _user$project$Lia_Chart_Parser$row = A2(
	_elm_community$parser_combinators$Combine_ops['<*'],
	A2(
		_elm_community$parser_combinators$Combine_ops['<$>'],
		...
		A2(
			...
			_elm_community$parser_combinators$Combine$regex('(( )*\\*)*'))),
	_elm_community$parser_combinators$Combine$regex('( )*\\n'));
var _user$project$Lia_Chart_Parser$diagram = function () {
	var points = F2(
		function (rows, _p0) {
			var _p1 = _p0;
			return _user$project$Lia_Chart_Types$Diagram(
				A2(
						...
						A2(
							...
							function (_p2) {
								...
								return A2(
									...
									function (x) {
										return A2(
											_user$project$Lia_Chart_Types$Point,
											(_elm_lang$core$Basics$toFloat(x) * _p1._1) + _p1._0,
	...
	return A2(
		...
		A2(
			_elm_community$parser_combinators$Combine_ops['<$>'],
			points,
			_elm_community$parser_combinators$Combine$many1(_user$project$Lia_Chart_Parser$row)),
		_user$project$Lia_Chart_Parser$x_axis);
}();
var _user$project$Lia_Chart_Parser$parse = _user$project$Lia_Chart_Parser$diagram;
...
var _user$project$Lia_Effect_Parser$ecomment = function (paragraph) {
	var number = A2(
		_elm_community$parser_combinators$Combine_ops['<*'],
		A2(
			_elm_community$parser_combinators$Combine_ops['*>'],
	...
	return A2(
		_elm_community$parser_combinators$Combine_ops['<*>'],
		A2(_elm_community$parser_combinators$Combine_ops['<$>'], _user$project$Lia_Types$EComment, number),
		paragraph);
};
var _user$project$Lia_Effect_Parser$einline = function (inlines) {
	...
	return A2(
		...
		A2(
			...
			A2(
				_elm_community$parser_combinators$Combine_ops['<$>'],
				_user$project$Lia_Inline_Types$EInline,
				A2(
					_elm_community$parser_combinators$Combine_ops['*>'],
					_elm_community$parser_combinators$Combine$string('{{'),
					_user$project$Lia_Effect_Parser$effect_number)),
...
var _user$project$Lia_Effect_Parser$eblock = function (blocks) {
	...
	return A2(
		...
		A2(
			...
			A2(
				_elm_community$parser_combinators$Combine_ops['<$>'],
				_user$project$Lia_Types$EBlock,
				A2(
					_elm_community$parser_combinators$Combine_ops['*>'],
					_elm_community$parser_combinators$Combine$regex('( *){{'),
					_user$project$Lia_Effect_Parser$effect_number)),
...
var _user$project$Lia_Inline_Parser$url_mail = _elm_community$parser_combinators$Combine$regex('( )*[^@]+@[^\\)\n ]+');
var _user$project$Lia_Inline_Parser$url_full = _elm_community$parser_combinators$Combine$regex('[a-zA-Z]+://(/)?[a-zA-Z0-9\\.\\-]+\\.([a-z\\.]{2,6})[^ \\)\\t\\n]*');
var _user$project$Lia_Inline_Parser$url = _elm_community$parser_combinators$Combine$lazy(
	function (_p4) {
		var _p5 = _p4;
		return _elm_community$parser_combinators$Combine$choice(
			{
				ctor: '::',
				_0: A2(_elm_community$parser_combinators$Combine_ops['<$>'], _user$project$Lia_Inline_Types$Full, _user$project$Lia_Inline_Parser$url_full),
				_1: {
					ctor: '::',
					_0: A2(_elm_community$parser_combinators$Combine_ops['<$>'], _user$project$Lia_Inline_Types$Mail, _user$project$Lia_Inline_Parser$url_mail),
					_1: {ctor: '[]'}
				}
			});
	});
var _user$project$Lia_Inline_Parser$inline_url = A2(
	_elm_community$parser_combinators$Combine_ops['<$>'],
	function (u) {
		return A2(
			_user$project$Lia_Inline_Types$Link,
			u,
			_user$project$Lia_Inline_Types$Full(u));
	},
	A2(_elm_community$parser_combinators$Combine_ops['<|>'], _user$project$Lia_Inline_Parser$url_full, _user$project$Lia_Inline_Parser$url_mail));
...
var _user$project$Lia_Inline_Parser$whitelines = _elm_community$parser_combinators$Combine$skip(
	_elm_community$parser_combinators$Combine$regex('[ \\t\\n]*'));
	...
	while (true) {
		...
		if (_p6.ctor === '[]') {
			...
			if (_p6._1.ctor === '[]') {
				...
				var _p9 = _p6._1._0;
				var _p8 = _p6._0;
				var _p7 = {ctor: '_Tuple2', _0: _p8, _1: _p9};
			...
			_user$project$Lia_Inline_Parser$stringTill(
				A2(
					...
					A2(
						_elm_community$parser_combinators$Combine_ops['*>'],
						_elm_community$parser_combinators$Combine$string('</'),
						_elm_community$parser_combinators$Combine$string(tag)),
					_elm_community$parser_combinators$Combine$string('>'))));
	};
	return A2(
		_elm_community$parser_combinators$Combine_ops['<$>'],
...
var _user$project$Lia_Inline_Parser$comment = function (p) {
	return A2(
		_elm_community$parser_combinators$Combine_ops['*>'],
		_elm_community$parser_combinators$Combine$string('<!--'),
		A2(
...
var _user$project$Lia_Inline_Parser$comments = _elm_community$parser_combinators$Combine$skip(
	_elm_community$parser_combinators$Combine$many(
		_user$project$Lia_Inline_Parser$comment(_elm_community$parser_combinators$Combine_Char$anyChar)));
var _user$project$Lia_Inline_Parser$reference = _elm_community$parser_combinators$Combine$lazy(
	function (_p13) {
		var _p14 = _p13;
		var url_ = _elm_community$parser_combinators$Combine$parens(
			A2(
				_elm_community$parser_combinators$Combine_ops['<|>'],
				_user$project$Lia_Inline_Parser$url,
				A2(
					_elm_community$parser_combinators$Combine_ops['<$>'],
					_user$project$Lia_Inline_Types$Partial,
					_elm_community$parser_combinators$Combine$regex('[^\\)\n]*'))));
		var style = _elm_community$parser_combinators$Combine$maybe(
			A2(
				...
				_elm_lang$core$String$fromList,
				_user$project$Lia_Inline_Parser$comment(_elm_community$parser_combinators$Combine_Char$anyChar)));
		var info = _elm_community$parser_combinators$Combine$brackets(
			_elm_community$parser_combinators$Combine$regex('[^\\]\n]*'));
		var link = A2(
			_elm_community$parser_combinators$Combine_ops['<*>'],
		...
		return _elm_community$parser_combinators$Combine$choice(
			{
				...
				_1: {
					ctor: '::',
					_0: A2(_elm_community$parser_combinators$Combine_ops['<$>'], _user$project$Lia_Inline_Types$Ref, _user$project$Lia_Inline_Parser$inline_url),
					_1: {
						ctor: '::',
						_0: _user$project$Lia_Inline_Parser$html,
						_1: {
...
var _user$project$Lia_Survey_Parser$modify_PState = function (survey_) {
		...
		var extractor = F2(
			function (fn, v) {
				return _elm_lang$core$Dict$fromList(
					A2(_elm_lang$core$List$map, fn, v));
			});
		var _p0 = survey_;
		switch (_p0.ctor) {
			case 'Text':
	...
	return A2(
		...
		_elm_community$parser_combinators$Combine$modifyState(
			add_state(state)),
		_elm_community$parser_combinators$Combine$succeed(survey_));
};
var _user$project$Lia_Survey_Parser$question = function (p) {
	return A2(
		_elm_community$parser_combinators$Combine_ops['<*>'],
		A2(
			_elm_community$parser_combinators$Combine_ops['<$>'],
			...
			p),
		A2(_elm_community$parser_combinators$Combine_ops['<*'], _user$project$Lia_Inline_Parser$line, _user$project$Lia_Inline_Parser$newline));
};
var _user$project$Lia_Survey_Parser$questions = _elm_community$parser_combinators$Combine$many1(
	A2(
		_elm_community$parser_combinators$Combine_ops['<*'],
		A2(
			_elm_community$parser_combinators$Combine_ops['*>'],
			...
			_user$project$Lia_Inline_Parser$line),
		_user$project$Lia_Inline_Parser$newline));
var _user$project$Lia_Survey_Parser$id_str = A2(
	_elm_community$parser_combinators$Combine_ops['*>'],
	_elm_community$parser_combinators$Combine$string(':'),
	_elm_community$parser_combinators$Combine$regex('[0-9a-zA-Z_ ]+'));
var _user$project$Lia_Survey_Parser$id_int = _elm_community$parser_combinators$Combine$regex('\\-?[0-9]+');
var _user$project$Lia_Survey_Parser$pattern = function (p) {
	return A2(
		_elm_community$parser_combinators$Combine_ops['<*'],
		A2(
			_elm_community$parser_combinators$Combine_ops['*>'],
...
var _user$project$Lia_Survey_Parser$vector = function (p) {
	var vec = function (x) {
		return _elm_community$parser_combinators$Combine$many1(
			_user$project$Lia_Survey_Parser$question(
				_user$project$Lia_Survey_Parser$pattern(
					p(x))));
	};
	return A2(
		_elm_community$parser_combinators$Combine_ops['<|>'],
		vec(_user$project$Lia_Survey_Parser$id_int),
		vec(_user$project$Lia_Survey_Parser$id_str));
};
var _user$project$Lia_Survey_Parser$header = function (p) {
	return A2(
		_elm_community$parser_combinators$Combine_ops['<*'],
		_user$project$Lia_Survey_Parser$pattern(
			_elm_community$parser_combinators$Combine$choice(
				{
					ctor: '::',
					_0: _elm_community$parser_combinators$Combine$many1(
						p(_user$project$Lia_Survey_Parser$id_int)),
					_1: {
						ctor: '::',
						_0: _elm_community$parser_combinators$Combine$many1(
							p(_user$project$Lia_Survey_Parser$id_str)),
						_1: {ctor: '[]'}
					}
				})),
		_user$project$Lia_Inline_Parser$newline);
};
var _user$project$Lia_Survey_Parser$text_lines = A2(
	_elm_community$parser_combinators$Combine_ops['<$>'],
		...
		A2(
			...
			A2(
				...
				_elm_community$parser_combinators$Combine$many1(
					A2(
						_elm_community$parser_combinators$Combine_ops['<*'],
						_elm_community$parser_combinators$Combine$regex('(__(_)+)'),
						_elm_community$parser_combinators$Combine$whitespace))),
			_elm_community$parser_combinators$Combine$string(']'))));
var _user$project$Lia_Survey_Parser$survey = function () {
	var get_id = function (par) {
		return _elm_community$parser_combinators$Combine$succeed(
			_elm_lang$core$Array$length(par.survey_vector));
	};
	return A2(
		_elm_community$parser_combinators$Combine_ops['<*>'],
		_elm_community$parser_combinators$Combine$choice(
			{
				ctor: '::',
				_0: A2(_elm_community$parser_combinators$Combine_ops['<$>'], _user$project$Lia_Survey_Types$Text, _user$project$Lia_Survey_Parser$text_lines),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_community$parser_combinators$Combine_ops['<$>'],
		...
		_elm_community$parser_combinators$Combine$withState(get_id));
}();
var _user$project$Lia_Survey_Parser$parse = A2(_elm_community$parser_combinators$Combine_ops['>>='], _user$project$Lia_Survey_Parser$survey, _user$project$Lia_Survey_Parser$modify_PState);
...
var _user$project$Lia_Parser$define_comment = function () {
	var version = function (x) {
		return _elm_community$parser_combinators$Combine$modifyState(
			function (s) {
				return _elm_lang$core$Native_Utils.update(
					s,
					{def_version: x});
	...
	var list = {
		...
		_0: A2(
			_elm_community$parser_combinators$Combine_ops['*>'],
			_elm_community$parser_combinators$Combine$string('author:'),
			A2(_elm_community$parser_combinators$Combine_ops['>>='], ending, author)),
		_1: {
			ctor: '::',
			_0: A2(
				_elm_community$parser_combinators$Combine_ops['*>'],
				_elm_community$parser_combinators$Combine$string('date:'),
				A2(_elm_community$parser_combinators$Combine_ops['>>='], ending, date)),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_community$parser_combinators$Combine_ops['*>'],
					_elm_community$parser_combinators$Combine$string('email:'),
					A2(_elm_community$parser_combinators$Combine_ops['>>='], ending, email)),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_community$parser_combinators$Combine_ops['*>'],
						_elm_community$parser_combinators$Combine$string('language:'),
						A2(_elm_community$parser_combinators$Combine_ops['>>='], ending, language)),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_community$parser_combinators$Combine_ops['*>'],
							_elm_community$parser_combinators$Combine$string('narator:'),
							A2(_elm_community$parser_combinators$Combine_ops['>>='], ending, narator)),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_community$parser_combinators$Combine_ops['*>'],
								_elm_community$parser_combinators$Combine$string('version:'),
								A2(_elm_community$parser_combinators$Combine_ops['>>='], ending, version)),
							_1: {ctor: '[]'}
						}
					}
				}
	...
	return _elm_community$parser_combinators$Combine$skip(
		_user$project$Lia_Inline_Parser$comment(
			A2(
				_elm_community$parser_combinators$Combine_ops['<*'],
				A2(
					_elm_community$parser_combinators$Combine_ops['*>'],
...
var _user$project$Lia_Parser$title_str = A2(
	...
	_elm_lang$core$String$trim,
	_elm_community$parser_combinators$Combine$regex('.+[\\n]+'));
var _user$project$Lia_Parser$title_tag = A2(
	_elm_community$parser_combinators$Combine_ops['<$>'],
	_elm_lang$core$String$length,
	A2(
		_elm_community$parser_combinators$Combine_ops['<*'],
	...
	var row = A2(
		...
		A2(
			...
			A2(
				_elm_community$parser_combinators$Combine_ops['*>'],
				_elm_community$parser_combinators$Combine$string('|'),
				_elm_community$parser_combinators$Combine$many(_user$project$Lia_Inline_Parser$inlines)),
			ending));
	var simple_table = A2(
		_elm_community$parser_combinators$Combine_ops['<*'],
		A2(
		...
		var b = _elm_community$parser_combinators$Combine$choice(
			{
				...
				_1: {
					ctor: '::',
					_0: _user$project$Lia_Effect_Parser$ecomment(_user$project$Lia_Parser$paragraph),
					_1: {
						ctor: '::',
						_0: A2(_elm_community$parser_combinators$Combine_ops['<$>'], _user$project$Lia_Types$Chart, _user$project$Lia_Chart_Parser$parse),
						_1: {
							ctor: '::',
...
var _user$project$Lia_Parser$slide = _elm_community$parser_combinators$Combine$lazy(
	function (_p2) {
		var _p3 = _p2;
		...
		return A2(
			...
			A2(
				...
				A2(
					_elm_community$parser_combinators$Combine_ops['<*>'],
					A2(_elm_community$parser_combinators$Combine_ops['<$>'], _user$project$Lia_Types$Slide, _user$project$Lia_Parser$title_tag),
					_user$project$Lia_Parser$title_str),
				body),
			effect_counter);
	});
var _user$project$Lia_Parser$parse = A2(
	_elm_community$parser_combinators$Combine_ops['*>'],
	...
	_elm_community$parser_combinators$Combine$many1(_user$project$Lia_Parser$slide));
var _user$project$Lia_Parser$run = function (script) {
	var _p4 = A3(_elm_community$parser_combinators$Combine$runParser, _user$project$Lia_Parser$parse, _user$project$Lia_PState$init, script);
	if (_p4.ctor === 'Ok') {
		var _p5 = _p4._0._0;
		return _elm_lang$core$Result$Ok(
			{ctor: '_Tuple5', _0: _p4._0._2, _1: _p5.code_vector, _2: _p5.quiz_vector, _3: _p5.survey_vector, _4: _p5.def_narator});
	} else {
		return _elm_lang$core$Result$Err(
			A2(_user$project$Lia_Parser$formatError, _p4._0._2, _p4._0._1));
	}
};
...
var _user$project$Tts_Responsive$speak = F3(
	function (resultToMessage, voice, text) {
		return A2(
			_elm_lang$core$Task$attempt,
			resultToMessage,
			A2(_user$project$Native_Responsive.speak, voice, text));
	});
var _user$project$Tts_Responsive$getVoices = function (_p0) {
	var _p1 = _user$project$Native_Responsive.getVoices(
		{ctor: '_Tuple0'});
	if (_p1.ctor === 'Ok') {
		return A2(
			_elm_lang$core$Json_Decode$decodeValue,
...
var _user$project$Tts_Responsive$cancel = function (_p2) {
	var _p3 = _user$project$Native_Responsive.cancel(
		{ctor: '_Tuple0'});
	if (_p3.ctor === 'Ok') {
		return true;
	} else {
...
var _user$project$Tts_Responsive$voiceSupport = function (_p4) {
	return _user$project$Native_Responsive.voiceSupport(
		{ctor: '_Tuple0'});
};
		...
		while (true) {
			var stop_talking = function (model) {
				...
				if (_p0.ctor === 'Speaking') {
					var c = _user$project$Tts_Responsive$cancel(
						{ctor: '_Tuple0'});
					return {
						ctor: '_Tuple3',
				...
				case 'Speak':
					...
					if (_p2.ctor === 'Just') {
						return {
							...
							_1: A3(_user$project$Tts_Responsive$speak, _user$project$Lia_Effect_Update$TTS, model.narator, _p2._0),
							_2: false
						};
					} else {
...
var _user$project$Lia_Helper$get_slide = F2(
	function (i, slides) {
		get_slide:
		while (true) {
			var _p0 = {ctor: '_Tuple2', _0: i, _1: slides};
			if (_p0._1.ctor === '[]') {
				return _elm_lang$core$Maybe$Nothing;
			} else {
				if (_p0._0 === 0) {
...
var _user$project$Lia_Helper$get_headers = function (slides) {
	return A2(
		...
		A2(
			_elm_lang$core$List$map,
			function (s) {
				return {ctor: '_Tuple2', _0: s.title, _1: s.indentation};
			},
			slides));
};
...
var _user$project$Lia_Quiz_Update$update_input = F3(
	function (idx, text, vector) {
		var _p2 = A2(_user$project$Lia_Quiz_Update$get, idx, vector);
		if (_p2.ctor === 'Just') {
			var _p4 = _p2._0;
			var _p3 = _p4.state;
...
var _user$project$Lia_Quiz_Update$update_hint = F2(
	function (idx, vector) {
		var _p5 = A2(_user$project$Lia_Quiz_Update$get, idx, vector);
		if (_p5.ctor === 'Just') {
			var _p6 = _p5._0;
			return A3(
				_elm_lang$core$Array$set,
...
var _user$project$Lia_Quiz_Update$RadioButton = F2(
	function (a, b) {
		return {ctor: 'RadioButton', _0: a, _1: b};
	});
var _user$project$Lia_Quiz_Update$CheckBox = F2(
	function (a, b) {
		return {ctor: 'CheckBox', _0: a, _1: b};
	});

var _user$project$Lia_Survey_Update$submitable = F2(
	function (model, idx) {
		var _p0 = A2(_elm_lang$core$Array$get, idx, model);
		if (((_p0.ctor === 'Just') && (_p0._0.ctor === '_Tuple2')) && (_p0._0._0 === false)) {
			switch (_p0._0._1.ctor) {
				case 'TextState':
					return !_elm_lang$core$Native_Utils.eq(_p0._0._1._0, '');
				case 'VectorState':
					return function (s) {
						...
						_elm_lang$core$List$length(
							A2(
								...
								_elm_lang$core$Dict$values(_p0._0._1._1))));
				default:
					return A2(
						...
						A2(
							...
							A2(
								...
								_elm_lang$core$Array$toList(_p0._0._1._1))));
			}
		} else {
			return false;
		}
	});
var _user$project$Lia_Survey_Update$submit = F2(
	function (model, idx) {
		...
		if (((_p1.ctor === 'Just') && (_p1._0.ctor === '_Tuple2')) && (_p1._0._0 === false)) {
			return A3(
				_elm_lang$core$Array$set,
				idx,
				{ctor: '_Tuple2', _0: true, _1: _p1._0._1},
				model);
		} else {
			return model;
		}
	});
var _user$project$Lia_Survey_Update$set_state = F3(
	function (model, idx, state) {
		return A3(
			_elm_lang$core$Array$set,
			idx,
			{ctor: '_Tuple2', _0: false, _1: state},
			model);
	});
var _user$project$Lia_Survey_Update$update_matrix = F4(
	function (model, idx, row, $var) {
		var _p2 = A2(_elm_lang$core$Array$get, idx, model);
		if ((((_p2.ctor === 'Just') && (_p2._0.ctor === '_Tuple2')) && (_p2._0._0 === false)) && (_p2._0._1.ctor === 'MatrixState')) {
			if (_p2._0._1._0 === false) {
				var _p6 = _p2._0._1._1;
				...
				var _p7 = _p2._0._1._1;
				var vector = A2(_elm_lang$core$Array$get, row, _p7);
				return A3(
					_user$project$Lia_Survey_Update$set_state,
					model,
					idx,
					A2(
						...
						A2(
							...
							A2(
								_elm_lang$core$Maybe$map,
								function (d) {
									return A3(_elm_lang$core$Array$set, row, d, _p7);
								},
								A2(
									_elm_lang$core$Maybe$map,
									function (d) {
...
var _user$project$Lia_Survey_Update$update_vector = F3(
	function (model, idx, $var) {
		var _p8 = A2(_elm_lang$core$Array$get, idx, model);
		if ((((_p8.ctor === 'Just') && (_p8._0.ctor === '_Tuple2')) && (_p8._0._0 === false)) && (_p8._0._1.ctor === 'VectorState')) {
			if (_p8._0._1._0 === false) {
				return A3(
					_user$project$Lia_Survey_Update$set_state,
					model,
					idx,
...
var _user$project$Lia_Survey_Update$update_text = F3(
	function (model, idx, str) {
		var _p12 = A2(_elm_lang$core$Array$get, idx, model);
		if ((((_p12.ctor === 'Just') && (_p12._0.ctor === '_Tuple2')) && (_p12._0._0 === false)) && (_p12._0._1.ctor === 'TextState')) {
			return A3(
				_user$project$Lia_Survey_Update$set_state,
				model,
				idx,
				_user$project$Lia_Survey_Types$TextState(str));
		} else {
			return model;
		}
	});
var _user$project$Lia_Survey_Update$update = F2(
	function (msg, model) {
		var _p13 = msg;
		switch (_p13.ctor) {
			case 'TextUpdate':
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Lia_Survey_Update$update_text, model, _p13._0, _p13._1),
					_1: _elm_lang$core$Maybe$Nothing
				};
			case 'VectorUpdate':
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Lia_Survey_Update$update_vector, model, _p13._0, _p13._1),
					_1: _elm_lang$core$Maybe$Nothing
				};
			case 'MatrixUpdate':
				return {
					ctor: '_Tuple2',
					_0: A4(_user$project$Lia_Survey_Update$update_matrix, model, _p13._0, _p13._1, _p13._2),
					_1: _elm_lang$core$Maybe$Nothing
				};
			default:
				var _p14 = _p13._0;
				if (A2(_user$project$Lia_Survey_Update$submitable, model, _p14)) {
					var new_model = A2(_user$project$Lia_Survey_Update$submit, model, _p14);
					return {
						ctor: '_Tuple2',
						_0: new_model,
						_1: _elm_lang$core$Maybe$Just(
...
var _user$project$Lia_Update$UpdateSurvey = function (a) {
	return {ctor: 'UpdateSurvey', _0: a};
};
...
var _user$project$Lia_Chart_View$view = function (chart) {
	var _p0 = chart;
	return A3(
		...
		_terezka$elm_plot$Plot$defaultSeriesPlotCustomizations,
		{
			...
			_0: {
				...
				toDataPoints: _elm_lang$core$List$map(
					function (_p1) {
						var _p2 = _p1;
						return A2(_terezka$elm_plot$Plot$circle, _p2.x, _p2.y);
					})
			},
			_1: {ctor: '[]'}
		},
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'border', _1: '2px solid #666'},
											_1: {
												ctor: '::',
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'font', _1: '12px Arial Bold, sans-serif'},
														_1: {ctor: '[]'}
													}
												}
											}
		...
		return _elm_lang$core$Native_Utils.eq(idx, model.visible) ? A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'transition', _1: '.1s ease'},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'opacity', _1: '0.6'},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'top', _1: '80%'},
									_1: {
										ctor: '::',
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: '-ms-transform', _1: 'translate(-50%, -50%)'},
													_1: {
														ctor: '::',
														...
														_1: {
															...
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: {ctor: '_Tuple2', _0: 'padding', _1: '16px 32px'},
																	_1: {ctor: '[]'}
																}
															}
														}
...
var _user$project$Lia_Effect_View$view_block = F5(
	function (model, viewer, idx, effect_name, blocks) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
					...
					_1: {
						...
						_0: function () {
							...
							if (_p0.ctor === 'Nothing') {
								...
								return _elm_lang$html$Html_Attributes$class(
									A2(_elm_lang$core$Basics_ops['++'], 'animated ', _p0._0));
							}
						}(),
						_1: {ctor: '[]'}
					}
...
var _user$project$Lia_Effect_View$view = F5(
	function (viewer, idx, visible, effect_name, elements) {
		return A2(
			_elm_lang$html$Html$span,
			{
				ctor: '::',
					...
					_1: {
						...
						_0: function () {
							...
							if (_p1.ctor === 'Nothing') {
								...
								return _elm_lang$html$Html_Attributes$class(
									A2(_elm_lang$core$Basics_ops['++'], 'animated ', _p1._0));
							}
						}(),
						_1: {ctor: '[]'}
					}
...
var _user$project$Lia_Inline_View$get_url = function (url) {
	var _p0 = url;
	switch (_p0.ctor) {
		case 'Full':
			return _p0._0;
			...
			if (_p1.ctor === 'Nothing') {
				return {
					...
					_0: _elm_lang$html$Html_Attributes$src(
						_user$project$Lia_Inline_View$get_url(url_)),
					_1: {ctor: '[]'}
				};
			} else {
				return {
					...
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$html$Html_Attributes$attribute, 'style', _p1._0),
						_1: {ctor: '[]'}
					}
				};
			}
			...
			return A2(
				_elm_lang$html$Html$a,
				{
					...
					_0: _elm_lang$html$Html_Attributes$href(
						_user$project$Lia_Inline_View$get_url(_p2._1)),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
		...
		switch (_p3.ctor) {
			...
			case 'Bold':
				return A2(
					...
					{
						ctor: '::',
						_0: A2(_user$project$Lia_Inline_View$view, visible, _p3._0),
						_1: {ctor: '[]'}
					});
			case 'Italic':
				return A2(
			...
			case 'Container':
				return A2(
					...
					A2(
						...
						_p3._0));
			case 'Ref':
				return _user$project$Lia_Inline_View$reference(_p3._0);
			case 'Formula':
				return A2(_user$project$Lia_Utils$formula, _p3._0, _p3._1);
			case 'Symbol':
				return _user$project$Lia_Utils$stringToHtml(_p3._0);
			case 'HTML':
				return _user$project$Lia_Utils$stringToHtml(_p3._0);
			default:
				return A5(
		...
		return A2(
			_elm_lang$html$Html$input,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: submitted ? _elm_lang$html$Html_Attributes$disabled(true) : _elm_lang$html$Html_Events$onClick(msg),
						_1: {ctor: '[]'}
					}
				}
			},
	...
	function (button, msg, fn, submitted, _p0) {
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_1: {
					ctor: '::',
					_0: _user$project$Lia_Survey_View$inline(_p1._1),
					_1: {ctor: '[]'}
				}
			});
	});
			...
			A2(
				...
				A2(
					...
					function ($var) {
						return A2(
							...
							{
								ctor: '::',
								_0: _user$project$Lia_Survey_View$mat_attr,
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
					...
					vars),
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Lia_Survey_View$inline(_p4._1),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}));
	});
var _user$project$Lia_Survey_View$view_matrix = F4(
	function (vars, questions, fn, submitted) {
...
var _user$project$Lia_Survey_View$view_vector = F3(
	function (questions, fn, submitted) {
		var fnX = fn(submitted);
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			A2(_elm_lang$core$List$map, fnX, questions));
	});
var _user$project$Lia_Survey_View$view_text = F4(
	function (str, lines, idx, submitted) {
		var attr = {
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onInput(
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$disabled(submitted),
					_1: {ctor: '[]'}
				}
			}
		};
				...
				_0: function () {
					...
					if (_p6 === 1) {
						...
						return A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$rows(lines),
								_1: attr
							},
							{ctor: '[]'});
					}
...
var _user$project$Lia_Survey_View$submit_button = F2(
	function (submitted, idx) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				...
				_0: submitted ? A2(
					...
					_elm_lang$html$Html$button,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Lia_Survey_Update$Submit(idx)),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$Lia_Survey_View$view_survey = F3(
	function (model, idx, fn) {
		var submitted = A2(_user$project$Lia_Survey_Model$get_submission_state, model, idx);
		return {
			ctor: '::',
			_0: fn(submitted),
			_1: {
				ctor: '::',
				_0: A2(_user$project$Lia_Survey_View$submit_button, submitted, idx),
				_1: {ctor: '[]'}
			}
		};
	});
				...
				switch (_p7.ctor) {
					case 'Text':
						...
						return A3(
							...
							_p8,
							A3(
								_user$project$Lia_Survey_View$view_text,
...
var _user$project$Lia_View$view_table = F4(
	function (model, header, format, body) {
		var style_ = _elm_lang$html$Html_Attributes$style(
			{
				...
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'border-color', _1: '#e0e0eb'},
					_1: {
						ctor: '::',
					...
					function (_p0) {
						...
						return A2(
							f,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$align(
										function () {
											var _p2 = A2(_elm_lang$core$Array$get, _p1._0, format);
											if (_p2.ctor === 'Just') {
												return _p2._0;
											} else {
												return 'left';
							...
							A2(
								_elm_lang$core$List$map,
								function (element) {
									return A2(_user$project$Lia_Inline_View$view, model.effect_model.visible, element);
								},
								_p1._1));
					},
					A2(
		...
		return A2(
			...
			{
				ctor: '::',
				_0: A2(_elm_lang$html$Html_Attributes$attribute, 'cellspacing', '0'),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$html$Html_Attributes$attribute, 'cellpadding', '8'),
					_1: {
						ctor: '::',
						_0: style_,
						_1: {ctor: '[]'}
			...
			},
			{
				...
				_0: A2(
					_elm_lang$html$Html$thead,
					{ctor: '[]'},
					A3(view_row, model, _elm_lang$html$Html$th, header)),
				_1: A2(
					_elm_lang$core$List$map,
					function (r) {
						return A2(
							_elm_lang$html$Html$tr,
							{ctor: '[]'},
							A3(view_row, model, _elm_lang$html$Html$td, r));
					},
					body)
			});
	});
var _user$project$Lia_View$view_block = F2(
	function (model, block) {
		...
		switch (_p3.ctor) {
			case 'Paragraph':
				return A2(
					...
					A2(
						_elm_lang$core$List$map,
						function (e) {
							return A2(_user$project$Lia_Inline_View$view, model.effect_model.visible, e);
						},
						_p3._0));
			case 'HLine':
				return A2(
			...
			case 'Table':
				return A4(
					_user$project$Lia_View$view_table,
					model,
					_p3._0,
					_elm_lang$core$Array$fromList(_p3._1),
					_p3._2);
			case 'Quote':
				return A2(
			...
			case 'CodeBlock':
				return A2(
					...
					A2(_user$project$Lia_Code_View$view, model.code_model, _p3._0));
			case 'Quiz':
				return A2(
					_elm_lang$html$Html$map,
			...
			case 'SurveyBlock':
				return A2(
					_elm_lang$html$Html$map,
					_user$project$Lia_Update$UpdateSurvey,
					A2(_user$project$Lia_Survey_View$view, model.survey_model, _p3._0));
			case 'EBlock':
				return A5(
			...
			case 'EComment':
				return A4(
					_user$project$Lia_Effect_View$comment,
					model.effect_model,
					_user$project$Lia_View$view_block(model),
					_p3._0,
					{
						ctor: '::',
						_0: _user$project$Lia_Types$Paragraph(_p3._1),
						_1: {ctor: '[]'}
					});
			default:
				return _user$project$Lia_Chart_View$view(_p3._0);
		}
	});
var _user$project$Lia_View$view_body = F2(
	function (model, body) {
		var f = _user$project$Lia_View$view_block(model);
		return A2(_elm_lang$core$List$map, f, body);
	});
...
var _user$project$Lia_View$view_slide = F2(
	function (model, slide) {
		return A2(
			...
			{
				ctor: '::',
				_0: A2(_user$project$Lia_View$view_header, slide.indentation, slide.title),
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_1: {
						ctor: '::',
						_0: A2(loadButton, '<<', _user$project$Lia_Update$PrevSlide),
						_1: {
							ctor: '::',
							_0: A2(loadButton, '>>', _user$project$Lia_Update$NextSlide),
							_1: {ctor: '[]'}
						}
					}
				}),
...
var _user$project$Lia_View$view_plain = function (model) {
	var f = _user$project$Lia_View$view_slide(
		_elm_lang$core$Native_Utils.update(
			model,
			{effect_model: _user$project$Lia_Effect_Model$init_silent}));
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		return _user$project$Lia$parse(
			{
				...
				survey_model: _elm_lang$core$Array$empty,
		...
		A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'resize', _1: 'horizontal'},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'overflow', _1: 'auto'},
							_1: {
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Load File'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
					...
					_0: A2(
						_elm_lang$html$Html$textarea,
						{
							...
							_0: _elm_lang$html$Html_Attributes$style(
								{
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'height', _1: 'calc(100% - 78px)'},
									_1: {
										ctor: '::',
