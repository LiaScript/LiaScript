...
var _user$project$Lia_Type$Slide = F3(
	function (a, b, c) {
		return {indentation: a, title: b, body: c};
	});
...
var _user$project$Lia_Helper$question_state = F3(
	function (quiz_id, question_id, matrix) {
		...
		if (_p0.ctor === 'Just') {
			var _p1 = A2(_elm_lang$core$Array$get, question_id, _p0._0._1);
			if (_p1.ctor === 'Just') {
				return _p1._0._0;
			} else {
				return false;
...
var _user$project$Lia_Parser$line = A2(
	...
	_elm_community$parser_combinators$Combine$many1(_user$project$Lia_Parser$inlines));
var _user$project$Lia_Parser$multiple_choice = function () {
	var checked = A2(
		_elm_community$parser_combinators$Combine_ops['<$>'],
		function (l) {
			return {ctor: '_Tuple2', _0: true, _1: l};
		},
		A2(
			_elm_community$parser_combinators$Combine_ops['<*'],
			A2(
	...
	var unchecked = A2(
		_elm_community$parser_combinators$Combine_ops['<$>'],
		function (l) {
			return {ctor: '_Tuple2', _0: false, _1: l};
		},
		A2(
			_elm_community$parser_combinators$Combine_ops['<*'],
			A2(
...
var _user$project$Lia_Parser$run = function (script) {
	...
	if (_p19.ctor === 'Ok') {
		...
		return _elm_lang$core$Result$Err(
			A2(_user$project$Lia_Parser$formatError, _p19._0._2, _p19._0._1));
	}
};
	...
	function (quiz_id, matrix) {
		...
		if (_p0.ctor === 'Just') {
			if ((_p0._0._0.ctor === 'Just') && (_p0._0._0._0 === true)) {
				...
				var _p3 = _p0._0._1;
				var a = _elm_lang$core$Debug$log('anser');
				var f = F2(
					function (_p1, r) {
						var _p2 = _p1;
						return r && _elm_lang$core$Native_Utils.eq(_p2._0, _p2._1);
					});
				var answer = _elm_lang$core$Maybe$Just(
					A3(_elm_lang$core$Array$foldr, f, true, _p3));
				var b = _elm_lang$core$Debug$log(
					_elm_lang$core$Basics$toString(answer));
				return A3(
					_elm_lang$core$Array$set,
					quiz_id,
					{ctor: '_Tuple2', _0: answer, _1: _p3},
					matrix);
			}
		} else {
			return matrix;
...
var _user$project$Lia_Update$flip_checkbox = F3(
	function (quiz_id, question_id, matrix) {
		var _p4 = A2(_elm_lang$core$Array$get, quiz_id, matrix);
		if (_p4.ctor === 'Just') {
			var _p10 = _p4._0._0;
			var _p9 = _p4._0._1;
			var _p5 = _p10;
			if ((_p5.ctor === 'Just') && (_p5._0 === true)) {
				...
				var _p6 = A2(_elm_lang$core$Array$get, question_id, _p9);
				if (_p6.ctor === 'Just') {
					return function (q) {
						return A3(
							_elm_lang$core$Array$set,
							quiz_id,
							{ctor: '_Tuple2', _0: _p10, _1: q},
							matrix);
					}(
						function (q) {
							return A3(_elm_lang$core$Array$set, question_id, q, _p9);
						}(
							function (_p7) {
								var _p8 = _p7;
				...
				case 'CheckBox':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								quiz: A3(_user$project$Lia_Update$flip_checkbox, _p11._0, _p11._1, model.quiz)
							}),
				...
				case 'Check':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								quiz: A2(_user$project$Lia_Update$check_answer, _p11._0, model.quiz)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'Speak':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{error: 'Speaking'}),
						_1: A4(_user$project$Tts_Tts$speak, _user$project$Lia_Type$TTS, _elm_lang$core$Maybe$Nothing, 'en_US', _p11._0)
					};
				default:
					if (_p11._0.ctor === 'Ok') {
						return {
...
var _user$project$Lia_View$view_quiz = F3(
	function (model, question, number) {
		var _p5 = question;
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
				...
				return A2(
					...
					l,
					{
						...
						_0: A2(
							...
							function () {
								var _p6 = A2(_user$project$Lia_Helper$quiz_state, number, model.quiz);
								if (_p6.ctor === 'Just') {
									return _p6._0 ? {
										ctor: '::',
										...
										_1: {
											...
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$Lia_Type$Check(number)),
											_1: {ctor: '[]'}
										}
									};
								} else {
							...
							{ctor: '[]'},
							{
									...
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											...
											_0: _elm_lang$html$Html_Attributes$checked(
												A3(_user$project$Lia_Helper$question_state, number, _p9, model.quiz)),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
													A2(_user$project$Lia_Type$CheckBox, number, _p9)),
												_1: {ctor: '[]'}
											}
										}
									},
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$span,
										{ctor: '[]'},
										A2(_elm_lang$core$List$map, _user$project$Lia_View$view_inline, _p8._1._1)),
									_1: {ctor: '[]'}
								}
							});
					},
		...
		switch (_p10.ctor) {
			case 'Paragraph':
				return A2(
					_elm_lang$html$Html$p,
					{ctor: '[]'},
					A2(_elm_lang$core$List$map, _user$project$Lia_View$view_inline, _p10._0));
			case 'HorizontalLine':
				return A2(
			...
			case 'Table':
				return A3(
					...
					_p10._0,
					_elm_lang$core$Array$fromList(_p10._1),
					_p10._2);
			case 'Quote':
				return A2(
				...
				return A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: A2(_user$project$Lia_Utils$highlight, _p10._0, _p10._1),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					});
			default:
				return A2(
					...
					{
						ctor: '::',
						_0: A3(_user$project$Lia_View$view_quiz, model, _p10._0, _p10._1),
						_1: {ctor: '[]'}
					});
		}
	});
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										_elm_lang$html$Html$a,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$Lia_Type$Load(_p13._0)),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$href(
													A2(
														...
														A2(
															_elm_lang$core$String$join,
															'_',
															A2(_elm_lang$core$String$split, ' ', _p14)))),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$style(
														{
															...
															_0: {
																...
																_1: A2(
																	_elm_lang$core$Basics_ops['++'],
																	_elm_lang$core$Basics$toString((_p13._1._1 - 1) * 20),
																	'px')
															},
															_1: {ctor: '[]'}
														}),
			...
			_1: {
				...
				_0: A2(
					...
					},
					{
						ctor: '::',
						_0: function () {
							var _p15 = A2(_user$project$Lia_Helper$get_slide, model.slide, model.lia);
							if (_p15.ctor === 'Just') {
								return A3(_elm_lang$html$Html_Lazy$lazy2, _user$project$Lia_View$view_slide, model, _p15._0);
							} else {
...
var _user$project$Lia_View$view_plain = function (model) {
	var f = _user$project$Lia_View$view_slide(model);
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
if (typeof _user$project$Editor$main !== 'undefined') {
    _user$project$Editor$main(Elm['Editor'], 'Editor', {"types":{"unions":{"Basics.Never":{"args":[],"tags":{"JustOneMore":["Basics.Never"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"SplitPane.Msg":{"args":[],"tags":{"SplitterClick":["SplitPane.DOMInfo"],"SplitterMove":["SplitPane.Position"],"SplitterLeftAlone":["SplitPane.Position"]}},"Lia.Type.Mode":{"args":[],"tags":{"Slides":[],"Plain":[]}},"Lia.Type.Msg":{"args":[],"tags":{"Check":["Int"],"Load":["Int"],"Speak":["String"],"CheckBox":["Int","Int"],"TTS":["Result.Result String Basics.Never"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Editor.Msg":{"args":[],"tags":{"Child":["Lia.Msg"],"Render":["Lia.Type.Mode"],"Inner":["SplitPane.Msg"],"Outer":["SplitPane.Msg"],"Update":["String"]}}},"aliases":{"SplitPane.Position":{"args":[],"type":"{ x : Int, y : Int }"},"Lia.Msg":{"args":[],"type":"Lia.Type.Msg"},"SplitPane.DOMInfo":{"args":[],"type":"{ x : Maybe.Maybe Int , y : Maybe.Maybe Int , touchX : Maybe.Maybe Int , touchY : Maybe.Maybe Int , parentWidth : Int , parentHeight : Int }"}},"message":"Editor.Msg"},"versions":{"elm":"0.18.0"}});
}
