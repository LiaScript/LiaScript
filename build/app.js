...
var _andre_dietrich$elm_responsive_voice$Native_Responsive = (function () {
...
var _andre_dietrich$elm_responsive_voice$Responsive$speak = F3(
	function (resultToMessage, voice, text) {
		return A2(
			_elm_lang$core$Task$attempt,
			resultToMessage,
			A2(_andre_dietrich$elm_responsive_voice$Native_Responsive.speak, voice, text));
	});
var _andre_dietrich$elm_responsive_voice$Responsive$getVoices = function (_p0) {
	var _p1 = _andre_dietrich$elm_responsive_voice$Native_Responsive.getVoices(
		{ctor: '_Tuple0'});
	if (_p1.ctor === 'Ok') {
		return A2(
...
var _andre_dietrich$elm_responsive_voice$Responsive$cancel = function (_p2) {
	var _p3 = _andre_dietrich$elm_responsive_voice$Native_Responsive.cancel(
		{ctor: '_Tuple0'});
	if (_p3.ctor === 'Ok') {
		return true;
	} else {
...
var _andre_dietrich$elm_responsive_voice$Responsive$voiceSupport = function (_p4) {
	return _andre_dietrich$elm_responsive_voice$Native_Responsive.voiceSupport(
		{ctor: '_Tuple0'});
};
		...
		switch (_p0.ctor) {
			...
			case 'EInline':
				return _elm_lang$core$String$concat(
					A2(_elm_lang$core$List$map, _user$project$Lia_Index_Model$parse_inline, _p0._2));
			default:
				return '';
		}
	}
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {script: a, error: b, slides: c, quiz_model: d, code_model: e, current_slide: f, mode: g, effects: h, narator: i, contents: j, index: k};
										};
									};
								};
							};
	...
	while (true) {
		...
		if (_p4.ctor === '[]') {
			...
			if (_p4._1.ctor === '[]') {
				...
				if (((_p5.ctor === '_Tuple2') && (_p5._0.ctor === 'Chars')) && (_p5._1.ctor === 'Chars')) {
					var _v4 = {
						ctor: '::',
						_0: _user$project$Lia_Inline_Types$Chars(
							A2(_elm_lang$core$Basics_ops['++'], _p5._0._0, _p5._1._0)),
						_1: _p8
					};
					list = _v4;
					continue combine;
		...
		while (true) {
			var stop_talking = function (model) {
				...
				if (_p0.ctor === 'Speaking') {
					var c = _andre_dietrich$elm_responsive_voice$Responsive$cancel(
						{ctor: '_Tuple0'});
					return {
						ctor: '_Tuple3',
				...
				case 'Speak':
					...
					if (_p2.ctor === 'Just') {
						return {
							...
							_1: A3(_andre_dietrich$elm_responsive_voice$Responsive$speak, _user$project$Lia_Effect_Update$TTS, model.narator, _p2._0),
							_2: false
						};
					} else {
		...
		return _user$project$Lia$parse(
			{
				...
				current_slide: 0,
				mode: mode,
				effects: A2(_user$project$Lia_Effect_Model$init, 'US English Male', _elm_lang$core$Maybe$Nothing),
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Lia.Index.Update.Msg":{"args":[],"tags":{"ScanIndex":["String"]}},"Lia.Code.Update.Msg":{"args":[],"tags":{"Eval":["Int","String"]}},"Basics.Never":{"args":[],"tags":{"JustOneMore":["Basics.Never"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Lia.Update.Msg":{"args":[],"tags":{"UpdateCode":["Lia.Code.Update.Msg"],"UpdateIndex":["Lia.Index.Update.Msg"],"UpdateQuiz":["Lia.Quiz.Update.Msg"],"Load":["Int"],"UpdateEffect":["Lia.Effect.Update.Msg"],"NextSlide":[],"PrevSlide":[],"ToggleContentsTable":[]}},"Lia.Types.Mode":{"args":[],"tags":{"Slides":[],"Plain":[]}},"Main.Msg":{"args":[],"tags":{"Child":["Lia.Msg"],"Render":["Lia.Types.Mode"],"Inner":["SplitPane.Msg"],"Outer":["SplitPane.Msg"],"Update":["String"]}},"SplitPane.Msg":{"args":[],"tags":{"SplitterClick":["SplitPane.DOMInfo"],"SplitterMove":["SplitPane.Position"],"SplitterLeftAlone":["SplitPane.Position"]}},"Lia.Effect.Update.Msg":{"args":[],"tags":{"Next":[],"Init":[],"Speak":[],"TTS":["Result.Result String Basics.Never"],"Previous":[]}},"Lia.Quiz.Update.Msg":{"args":[],"tags":{"Check":["Int"],"Input":["Int","String"],"RadioButton":["Int","Int"],"ShowHint":["Int"],"CheckBox":["Int","Int"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"SplitPane.Position":{"args":[],"type":"{ x : Int, y : Int }"},"Lia.Msg":{"args":[],"type":"Lia.Update.Msg"},"SplitPane.DOMInfo":{"args":[],"type":"{ x : Maybe.Maybe Int , y : Maybe.Maybe Int , touchX : Maybe.Maybe Int , touchY : Maybe.Maybe Int , parentWidth : Int , parentHeight : Int }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
