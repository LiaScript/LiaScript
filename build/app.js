...
var _user$project$Lia_Helper$question_state = F3(
	function (quiz_id, question_id, matrix) {
...
var _user$project$Lia_Update$flip_checkbox = F3(
	function (quiz_id, question_id, matrix) {
		var _p8 = A2(_elm_lang$core$Array$get, quiz_id, matrix);
		_v2_3:
		do {
			_v2_0:
			do {
...
var _user$project$Lia_View$view_inline = function (element) {
	var _p1 = element;
	switch (_p1.ctor) {
		case 'Code':
			return A2(
		...
		case 'Bold':
			return A2(
				...
				{
					ctor: '::',
					_0: _user$project$Lia_View$view_inline(_p1._0),
					_1: {ctor: '[]'}
				});
		case 'Italic':
			return A2(
					...
					function (_p2) {
						...
						return A2(
							f,
							{
								...
								_1: {
									...
									_0: _elm_lang$html$Html_Attributes$align(
										function () {
											var _p4 = A2(_elm_lang$core$Array$get, _p3._0, format);
											if (_p4.ctor === 'Just') {
												return _p4._0;
											} else {
												return 'left';
							...
							A2(
								_elm_lang$core$List$map,
								function (element) {
									return _user$project$Lia_View$view_inline(element);
								},
								_p3._1));
					},
					A2(
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{ctor: '[]'},
					A2(view_row, _elm_lang$html$Html$th, header)),
				_1: A2(
					_elm_lang$core$List$map,
					function (r) {
						return A2(
							...
							{ctor: '[]'},
							A2(view_row, _elm_lang$html$Html$td, r));
					},
					body)
			});
	});
var _user$project$Lia_View$quiz_check_button = F2(
	function (model, idx) {
		return A2(
			...
			function () {
				var _p5 = A2(_user$project$Lia_Helper$quiz_state, idx, model.quiz);
				if (_p5.ctor === 'Just') {
					return _p5._0 ? {
						ctor: '::',
							...
							{ctor: '[]'},
							{
									...
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											...
											_0: _elm_lang$html$Html_Attributes$checked(
												A3(_user$project$Lia_Helper$question_state, idx, _p8, model.quiz)),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
													A2(_user$project$Lia_Type$RadioButton, idx, _p8)),
												_1: {ctor: '[]'}
											}
										}
									},
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$span,
										{ctor: '[]'},
										A2(_elm_lang$core$List$map, _user$project$Lia_View$view_inline, _p7._1)),
									_1: {ctor: '[]'}
								}
							});
					},
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$checked(
												A3(_user$project$Lia_Helper$question_state, idx, _p11, model.quiz)),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
													A2(_user$project$Lia_Type$CheckBox, idx, _p11)),
												_1: {ctor: '[]'}
											}
										}
									},
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$span,
										{ctor: '[]'},
										A2(_elm_lang$core$List$map, _user$project$Lia_View$view_inline, _p10._1._1)),
									_1: {ctor: '[]'}
								}
							});
					},
...
var _user$project$Lia_View$view_quiz = F3(
	function (model, quiz, idx) {
		var _p12 = quiz;
		switch (_p12.ctor) {
			case 'TextInput':
				return A2(_user$project$Lia_View$view_quiz_text_input, model, idx);
			case 'SingleChoice':
				return A4(_user$project$Lia_View$view_quiz_single_choice, model, _p12._0, _p12._1, idx);
			default:
				return A3(_user$project$Lia_View$view_quiz_multiple_choice, model, _p12._0, idx);
		}
	});
		...
		switch (_p13.ctor) {
			case 'Paragraph':
				return A2(
					_elm_lang$html$Html$p,
					{ctor: '[]'},
					A2(_elm_lang$core$List$map, _user$project$Lia_View$view_inline, _p13._0));
			case 'HorizontalLine':
				return A2(
			...
			case 'Table':
				return A3(
					...
					_p13._0,
					_elm_lang$core$Array$fromList(_p13._1),
					_p13._2);
			case 'Quote':
				return A2(
				...
				return A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: A2(_user$project$Lia_Utils$highlight, _p13._0, _p13._1),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					});
					...
					_elm_lang$html$Html$div,
					{
						...
						_1: {
							...
							_0: _elm_lang$html$Html_Attributes$hidden(
								_elm_lang$core$Native_Utils.cmp(_p14, model.visible) > 0),
							_1: {ctor: '[]'}
						}
					},
					{
						ctor: '::',
						_0: _user$project$Lia_View$draw_circle(_p14),
						_1: A2(
							_elm_lang$core$List$map,
							function (sub) {
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					_elm_lang$html$Html$a,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Lia_Type$Load(_p17._0)),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$href(
								A2(
									...
									A2(
										_elm_lang$core$String$join,
										'_',
										A2(_elm_lang$core$String$split, ' ', _p18)))),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$style(
									{
										...
										_0: {
											...
											_1: A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString((_p17._1._1 - 1) * 20),
												'px')
										},
										_1: {ctor: '[]'}
									}),
						...
						_1: {
							...
							_0: A2(
								...
								},
								{
									ctor: '::',
									_0: function () {
										var _p19 = A2(_user$project$Lia_Helper$get_slide, model.slide, model.lia);
										if (_p19.ctor === 'Just') {
											return A3(_elm_lang$html$Html_Lazy$lazy2, _user$project$Lia_View$view_slide, model, _p19._0);
										} else {
	...
	if (_p0.ctor === 'Ok') {
		...
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				lia: _p1,
				error: '',
				quiz: _user$project$Lia_Helper$quiz_matrix(_p1)
			});
	} else {
		return _elm_lang$core$Native_Utils.update(
			model,
...
if (typeof _user$project$Editor$main !== 'undefined') {
    _user$project$Editor$main(Elm['Editor'], 'Editor', {"types":{"unions":{"Basics.Never":{"args":[],"tags":{"JustOneMore":["Basics.Never"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"SplitPane.Msg":{"args":[],"tags":{"SplitterClick":["SplitPane.DOMInfo"],"SplitterMove":["SplitPane.Position"],"SplitterLeftAlone":["SplitPane.Position"]}},"Lia.Type.Mode":{"args":[],"tags":{"Slides":[],"Plain":[]}},"Lia.Type.Msg":{"args":[],"tags":{"Check":["Int"],"Load":["Int"],"Input":["Int","String"],"Speak":["String"],"RadioButton":["Int","Int"],"NextSlide":[],"CheckBox":["Int","Int"],"TTS":["Result.Result String Basics.Never"],"PrevSlide":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Editor.Msg":{"args":[],"tags":{"Child":["Lia.Msg"],"Render":["Lia.Type.Mode"],"Inner":["SplitPane.Msg"],"Outer":["SplitPane.Msg"],"Update":["String"]}}},"aliases":{"SplitPane.Position":{"args":[],"type":"{ x : Int, y : Int }"},"Lia.Msg":{"args":[],"type":"Lia.Type.Msg"},"SplitPane.DOMInfo":{"args":[],"type":"{ x : Maybe.Maybe Int , y : Maybe.Maybe Int , touchX : Maybe.Maybe Int , touchY : Maybe.Maybe Int , parentWidth : Int , parentHeight : Int }"}},"message":"Editor.Msg"},"versions":{"elm":"0.18.0"}});
}
